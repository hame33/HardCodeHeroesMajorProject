      ...
      goal_pub_(goal_pub)
{
    ...
    completed_goals_.emplace_back(0.0, 0.0);
...
void WaypointManager::publish_markers()
{
    ...
    for (const auto& [distance, waypoint] : waypoints_)
    {
        ...
        marker.color.r = 1.0;  // Corrected color value from 10.0 to 1.0
        marker.color.g = 1.0;
        marker.color.b = 0.0;
        marker.color.a = 1.0;
...
void WaypointManager::process_goal_result(const std_msgs::msg::String::SharedPtr goal_result)
{
    if (goal_result->data == "Success")
    {
        ...
        completed_goals_.emplace_back(closest_frontier_goal_);
        publish_goal_check_ = 1;
    }
...
// --- publish_return_to_start ---
void WaypointManager::publish_return_to_start()
{
    publish_goal_check_ = 1;
    publish_goal();
}
